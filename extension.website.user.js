...
(async function () {
                ...
                for (const iframe of iframes) {
                    try {
                        if (iframe.contentWindow.VideoTogetherParentInject != true &&
                            ...
                            script.src = "https://videotogether.github.io/release/extension.website.user.js";
    ...
    try {
        ...
        if (cachedVersion == vtRefreshVersion) {
            ...
            fetch(`https://videotogether.github.io/release/vt.${language}.${vtType}.js?vtRefreshVersion=` + vtRefreshVersion)
                .then(r => r.text())
...
`;
    ...
    switch (type) {
        case "userscript":
            script.src = `https://videotogether.github.io/release/vt.${language}.user.js?timestamp=` + version;
            break;
        case "Chrome":
        case "Safari":
        case "Firefox":
        ...
        case "userscript_beta":
            ...
            break;
        case "website":
            script.src = `https://videotogether.github.io/release/vt.${language}.website.js?timestamp=` + version;
            break;
        case "website_debug":
